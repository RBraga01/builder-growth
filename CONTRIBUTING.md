# Contributing to builder-growth

## The Builder-Growth Test

Before proposing a new skill or agent, ask:

> **Would this be essential for at least 50% of teams doing AI-assisted growth work?**

If the answer is "it depends heavily on the channel or domain" — it belongs in a specialised extension, not in this pack. builder-growth is a baseline, not a comprehensive catalogue.
...
- Enforces something that growth teams consistently skip
...
- Skills specific to a single platform or channel
